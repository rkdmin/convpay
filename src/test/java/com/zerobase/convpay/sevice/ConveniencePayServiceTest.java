...
class ConveniencePayServiceTest {
    ...
    void pay_success(){
        // given
        PayRequest payRequest = new PayRequest(ConvenienceType.G25, 1000_000);
    ...
    void pay_cancel_success(){
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.SEVEN, 10000);
    ...
    void pay_cancel_fail(){
        // given
        PayCancelRequest payCancelRequest = new PayCancelRequest(ConvenienceType.SEVEN, 10);
